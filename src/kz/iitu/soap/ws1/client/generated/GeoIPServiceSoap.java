...
public interface GeoIPServiceSoap {
    ...
    @RequestWrapper(localName = "GetIpLocation", targetNamespace = "http://lavasoft.com/", className = "kz.iitu.soap.ws1.client.generated.GetIpLocation")
    @ResponseWrapper(localName = "GetIpLocationResponse", targetNamespace = "http://lavasoft.com/", className = "kz.iitu.soap.ws1.client.generated.GetIpLocationResponse")
    ...
    @RequestWrapper(localName = "GetIpLocation_2_0", targetNamespace = "http://lavasoft.com/", className = "kz.iitu.soap.ws1.client.generated.GetIpLocation20")
    @ResponseWrapper(localName = "GetIpLocation_2_0Response", targetNamespace = "http://lavasoft.com/", className = "kz.iitu.soap.ws1.client.generated.GetIpLocation20Response")
    ...
    @RequestWrapper(localName = "GetLocation", targetNamespace = "http://lavasoft.com/", className = "kz.iitu.soap.ws1.client.generated.GetLocation")
    @ResponseWrapper(localName = "GetLocationResponse", targetNamespace = "http://lavasoft.com/", className = "kz.iitu.soap.ws1.client.generated.GetLocationResponse")
    ...
    @RequestWrapper(localName = "GetCountryISO2ByName", targetNamespace = "http://lavasoft.com/", className = "kz.iitu.soap.ws1.client.generated.GetCountryISO2ByName")
    @ResponseWrapper(localName = "GetCountryISO2ByNameResponse", targetNamespace = "http://lavasoft.com/", className = "kz.iitu.soap.ws1.client.generated.GetCountryISO2ByNameResponse")
    ...
    @RequestWrapper(localName = "GetCountryNameByISO2", targetNamespace = "http://lavasoft.com/", className = "kz.iitu.soap.ws1.client.generated.GetCountryNameByISO2")
    @ResponseWrapper(localName = "GetCountryNameByISO2Response", targetNamespace = "http://lavasoft.com/", className = "kz.iitu.soap.ws1.client.generated.GetCountryNameByISO2Response")
